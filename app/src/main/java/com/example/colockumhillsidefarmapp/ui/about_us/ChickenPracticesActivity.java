...
public class ChickenPracticesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layerHens.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
                builder.setMessage("Our layer chickens are cheerful chickens because we treat them with kindness and respect. We believe that when our hens are happy and unstressed, they produce plentiful and tastier eggs.\n" +
                                "\n" +
        ...
        turkey2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
                builder.setMessage("We love our Midget White Turkeys! This is the only poultry that we have successfully bred on our farm. We keep a breeding flock of Midget Whites year round, and they are housed with the laying flock of chickens in our dormant garden over winter.\n" +
                                "\n" +
